...
global fs, output_path, var_name, lat_min, lat_max, lon_min, lon_max, max_attempts
...
if __name__ == '__main__':
    ...
    # Parallel processing
    parser.add_argument('--parallel', action='store_true', help='Enable parallel processing', default=True)
    ...
    # Get goes2go object
    print('Getting GOES object...')
    G = GOES(satellite=args.satellite, product=args.product, channel=args.channel)
